...
//! | `NEAT_AI_DISCOVERY_GPU_STALL_WINDOW_SECS` | u64 | `30` | Seconds of no GPU-thread progress before a submitter declares the GPU wedged (1–600; `0` disables, leaving the batch timeout as the only bound) (Issue #1933) |
