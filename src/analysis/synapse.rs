...
use crate::analysis::activation::{
    ...
    identity_activation, logistic_activation, mish_activation, relu6_activation,
    softplus_activation, softsign_activation, tanh_activation, ActivationCandidateSpec,
};
...
/// saturated and outputs nearly-constant values regardless of input.
...
#[derive(Copy, Clone)]
pub(crate) enum TargetSimulationMode {
...
#[inline]
pub(crate) fn get_target_activation_fn(squash: &str) -> Option<fn(f32) -> f32> {
...
#[inline]
pub(crate) fn get_target_simulation_fn(
...
#[inline]
pub(crate) fn get_target_simulation_mode(
    samples: &[HelpfulSample],
    target_squash: Option<&str>,
...
#[inline]
#[cfg(test)]
pub(crate) fn can_use_hard_tanh(samples: &[HelpfulSample], target_squash: Option<&str>) -> bool {
    matches!(
        target_squash,
...
pub(crate) fn has_sufficient_output_variance(
    samples: &[HelpfulSample],
    incoming_weight: f32,
    bias: f32,
