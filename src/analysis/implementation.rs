...
// Note: get_bias_range, get_bias_values moved to weights module usage (Issue #270)
// Note: Target simulation functions moved here from implementation.rs (Issue #238)
#[cfg(test)]
use crate::analysis::activation::can_use_hard_tanh;
use crate::analysis::activation::{
    ...
    has_sufficient_output_variance, identity_activation, is_threshold_activation,
    logistic_activation, mish_activation, relu6_activation, softplus_activation,
    softsign_activation, tanh_activation, ActivationCandidateSpec, TargetSimulationMode,
    ACTIVATION_SPECS,
};
...
// hard_tanh function moved to crate::analysis::weights module (Issue #270)
// get_target_activation_fn, get_target_simulation_fn, get_target_simulation_mode,
// TargetSimulationMode, can_use_hard_tanh moved to crate::analysis::activation (Issue #238)
