...
mod tests_synapses {
    ...
    use crate::{AnalyzeAllInput, AnalyzeNeuronsInput, CreatureJson, NeuronJson, SynapseJson};
    ...
    use crate::analysis::activation::{
        bipolar_activation, identity_activation, is_threshold_activation, logistic_activation,
        tanh_activation,
    };
    ...
    use crate::analysis::diagnostics::{
        filter_focus_targets_for_neuron_analysis, NeuronDiagnostics,
    };
    use crate::analysis::shared::NeuronNoCandidateReason;
